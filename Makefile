all: etfg_i386/src_sym_exec_db etfg_i386/src.insn.usedef.preprocessed etfg_i386/fb.trans.tab \
     i386_i386/src_sym_exec_db i386_i386/src.insn.usedef.preprocessed \
     x64_x64/src_sym_exec_db x64_x64/src.insn.usedef.preprocessed
...
clean:
	rm -f \
        ...
        etfg_x64/src_sym_exec_db etfg_x64/src.insn.usedef.preprocessed etfg_x64/src.insn.types.preprocessed etfg_x64/fb.trans.tab \
	      x64_x64/src_sym_exec_db x64_x64/src.insn.usedef.preprocessed x64_x64/src.insn.types.preprocessed x64_x64/fb.trans.tab
